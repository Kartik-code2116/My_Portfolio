...
## Assets and behavior
- **Styles (css/style.css)** – A single stylesheet defining the layout grid, glass panels, buttons, responsive breakpoint rules, typography, and the eveal animation states used across every page.
